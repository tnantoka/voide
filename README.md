...
Options:
  ...
  -i, --input        path/to/source.md                       [string] [required]
  -o, --output       path/to/output.d/                       [string] [required]
  -s, --speaker      0: 四国めたん (あまあま)
                     1: ずんだもん (あまあま)
                     2: 四国めたん (ノーマル)
                     3: ずんだもん (ノーマル)
                     4: 四国めたん (セクシー)
                     ...
                     33: 白上虎太郎 (びくびく)
                     34: 白上虎太郎 (おこ)
                     35: 白上虎太郎 (びえーん)               [number] [required]
  -t, --title                                                [string] [required]
  -d, --description                                                     [string]
  -w, --wait         page:seconds                                     [配列]
```
